  ...
  return (
    <>
      ...
      <main className="mx-auto w-full max-w-reading px-major py-12">
        <h1 className="font-serif text-2xl leading-8 text-fg-strong">dfdl ui</h1>
        <p className="mt-minor text-base leading-6 text-fg">
        ...
        <p className="mt-major text-sm leading-6 text-fg-secondary">
