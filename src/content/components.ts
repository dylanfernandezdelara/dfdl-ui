...
toast.add({ title: "Saved", description: "…" })`,
    ...
    props: [
      ...
      { name: "Toaster toastManager", type: "ReturnType<typeof createToastManager>", description: "A manager made outside React; call its add() from code the Toaster does not wrap." },
